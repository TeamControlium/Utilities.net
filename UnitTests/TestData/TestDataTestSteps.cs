...
namespace TeamControlium.Utilities
{
    ...
    public sealed class TestDataTestSteps
    {
        ...
        public void GivenIHaveSavedTestDataInItemNamedInCategory(int itemIndex, string item, string name, string category)
        {
            ...
            Utilities.TestData.Repository[category, name] = item;
        }
        ...
        public void GivenIHaveSavedItemsInCategory(string category)
        {
            ...
            Utilities.TestData.Repository[category] = ((Dictionary<string, dynamic>)ScenarioContext.Current[$"Dictionary"]);
        }
        ...
        {
            dynamic value;
            if (Utilities.TestData.Repository.TryGetItem<dynamic>(category, name, out value))
                ScenarioContext.Current[$"Recalled-{itemIndex}"] = value;
            else
                ScenarioContext.Current[$"Recalled-{itemIndex}"] = Utilities.TestData.Repository.TryException;
        }
        ...
        public void WhenIChangeTestDataItemNamedInCategoryTo(int itemIndex, string name, string category, string newValue)
        {
            ...
            Utilities.TestData.Repository[category, name] = newValue;
        }
        ...
        {
            int value;
            if (Utilities.TestData.Repository.TryGetItem<int>(category, name, out value))
                ScenarioContext.Current[$"Recalled-{itemIndex}"] = value;
            else
                ScenarioContext.Current[$"Recalled-{itemIndex}"] = Utilities.TestData.Repository.TryException;
        }
        ...
        {
            Utilities.TestData.Repository.Clear();
        }
