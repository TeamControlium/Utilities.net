...
Scenario Outline: Log only outputs levels equal to higher than the level selected
	Given I have configured Log WriteToConsole to true
...
Scenario Outline: Log output can be directed to Console or a custom output stream
	Given I have configured Log WriteToConsole to <Write To Console>
    And I have <Test Tool Log> Log TestToolLog delegate
...
| WriteToConsole True - TestToolLog not configured  | true             | not configured | "Test Framework Debug" | "FKDBG"           | ""                 | "Test Framework Debug" | ""                     |
| WriteToConsole False - TestToolLog not configured | false            | not configured | "Test Framework Debug" | "FKDBG"           | ""                 | "Test Framework Debug" | ""                     |
| WriteToConsole True - TestToolLog configured      | true             | configured     | "Test Framework Debug" | "FKDBG"           | "FKDBG"            | "Test Framework Debug" | "Test Framework Debug" |
| WriteToConsole False - TestToolLog configured     | false            | configured     | "Test Framework Debug" | ""                | "FKDBG"            | ""                     | "Test Framework Debug" |

Scenario Outline: Log output can be changed in flight
	Given I set Log to level FrameworkDebug
	And I have configured Log WriteToConsole to <Initial Write To Console>
    And I have <Test Tool Log Initially Configured> Log TestToolLog delegate
	And I call Log.WriteLine with level FrameworkDebug and string <First Test String>
	When I change Log WriteToConsole to <Second Write To Console>
	And I have <Test Tool Log Second Configured> Log TestToolLog delegate
